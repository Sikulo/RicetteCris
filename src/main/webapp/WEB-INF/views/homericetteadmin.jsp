		...
		<div class="content">
			...
			<c:forEach var="ricet" items="${ricettecollection}">
				<li>
					...
					<a href= "delete/${ricet.id}"> <button type="button" class="btn btn-default" aria-label="Left Align"> <span class=" glyphicon glyphicon-trash"></span> </button> </a>
					<a href= "edit/${ricet.id}"> <button type="button" class="btn btn-default" aria-label="Left Align"> <span class=" glyphicon glyphicon-pencil"></span> </button> </a>
				</li>
			</c:forEach>
			</ul>
		</div>
